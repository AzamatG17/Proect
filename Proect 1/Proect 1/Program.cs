...
namespace Proect_1
{
    internal class Program
    {
        ...
        static async Task ConnectAsync()
        {
            ...
            {
                case 1:
                    GetIncomesInputAsync();
                    break;
                case 2:
                    GetExpensesInputAsync();
                    break;
                case 3:
                    GetCategoriesInputAsync();
                    break;
                default:
                    return;
            }
        ...
        public static async Task GetCategoriesInputAsync()
        {

        }

        public static async Task GetIncomesInputAsync() 
        { 
        }

        public static async Task GetExpensesInputAsync()
        {
